    ...
    <div className="flex flex-col h-screen bg-gradient-to-br from-[#0a0a0a] to-[#111827] text-white overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          ...
          className={`fixed top-0 left-0 z-30 h-full bg-gradient-to-b from-[#111111] to-[#0d0d0d] border-r border-white/10 transform transition-all duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 shadow-xl ${
              ...
              <nav className="space-y-6 mt-16">
                {navItems.map((section) => (
                  <div className="mt-5" key={section.section}>
                    <p
                      className={`px-2 text-xs font-semibold text-white/40 uppercase tracking-wider mb-3 ${
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <main
            className={`flex-1 overflow-y-auto bg-[#0a0a0a] ${
              !pathname.startsWith("/dashboard/messages") ? "p-" : ""
            }`}
          >
